...
class VeterinarioController extends Action
{
    ...
    public function cadastrar()
    {
        ...
        $model->__set('vet_nome',        $_POST['nome']            ?? '');
        $model->__set('vet_cpf',         $_POST['cpf']             ?? '');
        $model->__set('vet_crmv',        $_POST['crmv']            ?? '');
        $model->__set('vet_dn',          $_POST['data_nascimento'] ?? null);
        $model->__set('vet_cep',         $_POST['cep']             ?? '');
        $model->__set('vet_estado',      $_POST['estado']          ?? '');
        $model->__set('vet_cidade',      $_POST['cidade']          ?? '');
        $model->__set('vet_bairro',      $_POST['bairro']          ?? '');
        $model->__set('vet_logradouro',  $_POST['logradouro']      ?? '');
        $model->__set('vet_numero',      $_POST['numero']          ?? '');
        $model->__set('vet_complemento', $_POST['complemento']     ?? '');
        $model->__set('vet_tel1',        $_POST['telefone']        ?? '');
        $model->__set('vet_tel2',        $_POST['telefone_2']      ?? '');
    ...
    {
        $model = new VeterinarioModel();
        $model->__set('vet_id',          $_POST['id']              ?? null);
        $model->__set('vet_nome',        $_POST['nome']            ?? '');
        $model->__set('vet_cpf',         $_POST['cpf']             ?? '');
        $model->__set('vet_crmv',        $_POST['crmv']            ?? '');
        $model->__set('vet_dn',          $_POST['data_nascimento'] ?? null);
