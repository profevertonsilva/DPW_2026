...
class AdotanteDAO extends DAO
{
    ...
    public function buscarPorId($id)
    {
        try {
            ...
            throw new \Exception("Erro ao buscar adotante por ID: " . $ex->getMessage());
        }
    }
    ...
    public function listar()
    {
        try {
            ...
            // LEFT JOIN garante que o adotante apareça mesmo sem login associado (evita travar o painel)
            $sql = "SELECT 
                        a.*,
                        l.email
                    FROM 
            ...
            echo "<h3>Erro SQL na Listagem:</h3><pre>" . $ex->getMessage() . "</pre>";
            die();
        }
    }
}