<?php
$veterinario = $this->getView()->veterinario;
?>
<div class="container-fluid">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1 class="h3 mb-0">Editar Veterinário</h1>
    ...
    <div class="card shadow">
        <div class="card-body">
            <form method="POST" action="/dashboard/veterinario/alterar">
                <input type="hidden" name="id" value="<?= htmlspecialchars($veterinario->__get('vet_id')) ?>">
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-6">
                        ...
                        <input type="text" class="form-control" id="nome" name="nome" required
                               value="<?= htmlspecialchars($veterinario->__get('vet_nome')) ?>">
                    </div>
                    <div class="col-md-3">
                        <label for="cpf" class="form-label">CPF</label>
                        <input type="text" class="form-control" id="cpf" name="cpf" maxlength="14"
                               placeholder="000.000.000-00"
                               value="<?= htmlspecialchars($veterinario->__get('vet_cpf')) ?>">
                    </div>
                    <div class="col-md-3">
                        <label for="crmv" class="form-label">CRMV</label>
                        <input type="text" class="form-control" id="crmv" name="crmv" placeholder="00000/UF"
                               value="<?= htmlspecialchars($veterinario->__get('vet_crmv')) ?>">
                    </div>
                    <div class="col-md-3">
                        <label for="data_nascimento" class="form-label">Data de Nascimento</label>
                        <input type="date" class="form-control" id="data_nascimento" name="data_nascimento"
                               value="<?= htmlspecialchars($veterinario->__get('vet_dn')) ?>">
                    </div>
                    <div class="col-md-4">
                        <label for="telefone" class="form-label">Telefone 1</label>
                        <input type="text" class="form-control" id="telefone" name="telefone"
                               placeholder="(00) 00000-0000"
                               value="<?= htmlspecialchars($veterinario->__get('vet_tel1')) ?>">
                    </div>
                    <div class="col-md-4">
                        ...
                        <input type="text" class="form-control" id="telefone_2" name="telefone_2"
                               placeholder="(00) 00000-0000"
                               value="<?= htmlspecialchars($veterinario->__get('vet_tel2')) ?>">
                    </div>
                </div>
                ...
                <div class="row g-3 mb-4">
                    <div class="col-md-3">
                        ...
                        <input type="text" class="form-control" id="cep" name="cep" maxlength="9"
                               ...
                               value="<?= htmlspecialchars($veterinario->__get('vet_cep')) ?>">
                    </div>
                    <div class="col-md-6">
                        <label for="logradouro" class="form-label">Logradouro</label>
                        <input type="text" class="form-control" id="logradouro" name="logradouro" readonly
                               value="<?= htmlspecialchars($veterinario->__get('vet_logradouro')) ?>">
                    </div>
                    <div class="col-md-3">
                        <label for="numero" class="form-label">Número</label>
                        <input type="text" class="form-control" id="numero" name="numero"
                               value="<?= htmlspecialchars($veterinario->__get('vet_numero')) ?>">
                    </div>
                    <div class="col-md-4">
                        <label for="complemento" class="form-label">Complemento</label>
                        <input type="text" class="form-control" id="complemento" name="complemento"
                               value="<?= htmlspecialchars($veterinario->__get('vet_complemento')) ?>">
                    </div>
                    <div class="col-md-4">
                        <label for="bairro" class="form-label">Bairro</label>
                        <input type="text" class="form-control" id="bairro" name="bairro" readonly
                               value="<?= htmlspecialchars($veterinario->__get('vet_bairro')) ?>">
                    </div>
                    <div class="col-md-3">
                        <label for="cidade" class="form-label">Cidade</label>
                        <input type="text" class="form-control" id="cidade" name="cidade" readonly
                               value="<?= htmlspecialchars($veterinario->__get('vet_cidade')) ?>">
                    </div>
                    <div class="col-md-1">
                        <label for="estado" class="form-label">UF</label>
                        <input type="text" class="form-control" id="estado" name="estado" readonly maxlength="2"
                               value="<?= htmlspecialchars($veterinario->__get('vet_estado')) ?>">
                    </div>
                </div>
