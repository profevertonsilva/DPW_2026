...
<nav id="navbar">
  ...
  <ul class="nav-links">
    ...
    <li><a href="/login" class="nav-btn" style="background: transparent !important; color: var(--orange) !important; box-shadow: none !important;">Login</a></li>
    <li><a href="/cadastro" class="nav-btn">Começar agora</a></li>
  </ul>
</nav>
...
<section class="hero">
  ...
  <div>
    ...
    <div class="hero-actions">
      <a href="/cadastro" class="btn-main">Começar gratuitamente →</a>
...
<section class="cta-section" id="cta">
  ...
  <div class="cta-btns">
    <a href="/cadastro" class="cta-btn-main">Criar conta gratuita</a>
