...
header("Location: /App/View/login.php"); //Envia para o dashboard para realização do teste do front-end, depois deve ser removido para direcionar para a página de login ou home, dependendo do fluxo de navegação definido.
exit(); 
